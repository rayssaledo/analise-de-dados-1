...
Será que...
  ...
  Primeiro precisamos saber qual dentre as séries possui a maior quantidade de avaliações positivas, na tabela abaixo utilizamos a mediana e a média como métrica de comparação, a série que possui o maior valor tanto de média e mediana está no topo da tabela, portanto, é a '*Sense8*.
...
Podemos perceber que houve variações nas notas, isso pode influenciar na avaliação geral da série, então precisamos saber de outra forma se a série ‘Sense8’ é realmente a melhor avaliada. 
...
De acordo com a tabela acima, que contém as séries com média e mediana mais altas, podemos observar que a série ‘Sense8’ com maior quantidade de avaliações positivas é uma das melhores avaliadas, porém não é a melhor avaliada. A série melhor avaliada pelo IMDB é a ‘Sherlock’.
